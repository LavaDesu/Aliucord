...
// This entirely replaces Discord's stock com.discord.api.botuikit
// The original enum is tiny, and it is much better to do this than a gigantic smali patch.
// When adding or removing fields, be sure to change the smali patches in
// com.discord.api.botuikit.gson.Component{Runtime,Type}TypeAdapter to reflect the length.
